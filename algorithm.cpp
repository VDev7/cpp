...
template <typename T>
void cpp::shuffle(std::vector<T>& a)
{
...
template <typename T>
void cpp::print_vector(const std::vector<T> a)
{
    std::cout << "[";
...
template<typename T>
int cpp::linear_search(std::vector<T> a)
{
    int n = a.size();
    T input;
...
template<typename T>
int cpp::binary_search(std::vector<T> a)
{
    int l = 0;
    int r = a.size() - 1;
    T input;
...
template<typename T>
void cpp::bubble_sort(std::vector<T>& a)
{
    bool is_swapped;
...
template <typename T>
void cpp::selection_sort(std::vector<T>& a)
{
    int n = a.size();
...
template <typename T>
void cpp::insertion_sort(std::vector<T>& a)
{
    int n = a.size();
